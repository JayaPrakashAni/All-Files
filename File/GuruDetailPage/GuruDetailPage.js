...
const GuruDetailsScreen = ({ route }) => {
    ...
    const getImageUri = () =>
        guruDetails.ProfilePicture
            ? `https://my.bmusician.com${guruDetails.ProfilePicture}`
            : require('../Assets/Guru/guruIcon.png');
                ...
                <>
                    ...
                    <View style={styles.experienceContainer}>
                        <View style={styles.experienceBox}>
                            ...
                            <Text style={styles.experienceText}>
                                Experience: {guruDetails.YearsOfExperience} Years
                            </Text>
                        </View>
                        <View style={styles.experienceBox}>
                            <Icon name="book" size={24} color="#ED4D57" />
                            <Text style={styles.experienceText}>
                                Teaching Exp: {guruDetails.YearsOfTeachingExperience} Years
                            </Text>
                        </View>
                    </View>
                    ...
                    {guruDetails.GalleryItems.map((item, index) => (
                        <View key={index} style={styles.galleryItem}>
                            <Image
                                source={{ uri: `https://my.bmusician.com${item.PathToPhoto}` }}
                    ...
                    {guruDetails.Name !== 'V.V Prassanna' && (
                        <>
