...
const SuruDetailsScreen = ({ route }) => {
    ...
    useEffect(() => {
        ...
        const fetchGuruDetails = async () => {
            try {
                const response = await fetch(`https://my.bmusician.com/app/gurudetails/6bcd94de-97c1-496b-b4e1-3c4e76265adb`);
...
export default SuruDetailsScreen;
