...
const ShyluGuruDetailsScreen = ({ route }) => {
    ...
    useEffect(() => {
        ...
        const fetchGuruDetails = async () => {
            try {
                const response = await fetch(`https://my.bmusician.com/app/gurudetails/964494a1-956d-4bae-b877-f038ee0e2e48`);
...
export default ShyluGuruDetailsScreen;
