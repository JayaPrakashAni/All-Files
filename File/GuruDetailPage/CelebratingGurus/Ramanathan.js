...
const RamaGuruDetailsScreen= ({ route }) => {
    ...
    useEffect(() => {
        ...
        const fetchGuruDetails = async () => {
            try {
                const response = await fetch(`https://my.bmusician.com/app/gurudetails/7643ae71-a30d-40cf-bfca-1cd6a43729ea`);
...
export default RamaGuruDetailsScreen;
